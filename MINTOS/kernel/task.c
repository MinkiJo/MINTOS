...
static uint32_t     sAllocated_tcb_index= 0 ;
...
uint32_t Kernel_get_current_task_id(void){
...
__attribute__ ((naked)) void task_start(void)
{
...
uint32_t Kernel_task_create(KernelTaskFunc_t startFunc)
{
   ...
   // sprintf(buf,"%d", sAllocated_tcb_index -1);
